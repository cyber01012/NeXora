...
public class WorkerService {
    ...
    private final nexora_backend.auth.service.UserTypeService userTypeService;
    ...
    public WorkerService(AdminUserRepository adminUserRepository,
                         ...
                         nexora_backend.auth.service.UserTypeService userTypeService) {
    ...
    public WorkerResponse addWorker(String responderUsername, WorkerAddRequest request) {
        ...
        String rawPassword = request.getPassword() != null ? request.getPassword() : "volunteer123";
        volunteer.setPassword(passwordEncoder.encode(rawPassword));
        
        volunteer.setActive(true);
        volunteer.setPhoneNumber(request.getPhone());
        volunteer.setEmail(request.getEmail());
        
        volunteer.setUserType(userTypeService.requireUserType(nexora_backend.auth.model.SystemRole.WORKER));
