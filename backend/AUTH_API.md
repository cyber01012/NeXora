...
Password is BCrypt-hashed before storage. User types are auto-seeded by name.
...
Email is **mandatory** for all non-citizen roles. Login blocked until `emailVerified=true`.
