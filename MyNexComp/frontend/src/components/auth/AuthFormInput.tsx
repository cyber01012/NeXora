      ...
      <input
        ...
        className={
          ...
          (isLanding
            ...
            : `w-full bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-[10px] ${icon ? "pl-[45px]" : "pl-4"} pr-4 py-3 font-['Orbitron',sans-serif] text-[16px] text-white placeholder:text-[rgba(255,255,255,0.4)] outline-none focus:border-[rgba(0,211,243,0.5)] transition-colors`)
        }
      />
    </div>
  );
