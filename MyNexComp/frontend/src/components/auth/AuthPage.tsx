...
export default function AuthPage({ onSuccess }: AuthPageProps) {
  ...
  return (
    <AuthRegistrationCard contentKey={contentKey} animateEntry={false}>
      {contentKey === "signin" && (
        <>
          <h2 className="mb-8 text-center text-white font-['Nasaliza',sans-serif] text-[24px] tracking-wide">Welcome Back</h2>
      ...
      {contentKey === "signup" && (
        <>
          <h2 className="mb-8 text-center text-white font-['Nasaliza',sans-serif] text-[24px] tracking-wide">Create Account</h2>
      ...
      {contentKey === "email-verify-prompt" && pendingVerification && (
        <>
          <h2 className="mb-2 text-center text-white font-['Nasaliza',sans-serif] text-[24px] tracking-wide">Account Created</h2>
      ...
      {contentKey === "email-link-sent" && pendingVerification && (
        <>
          <h2 className="mb-2 text-center text-white font-['Nasaliza',sans-serif] text-[24px] tracking-wide">Check Your Email</h2>
          <p className="mb-8 text-center text-sm text-white/60">
      ...
      {(contentKey === "forgot-1" || contentKey === "forgot-2") && (
        <>
          ...
          {contentKey === "forgot-1" && (
            <>
              <h2 className="mb-2 text-center text-white font-['Nasaliza',sans-serif] text-[24px] tracking-wide">Forgot Password</h2>
          ...
          {contentKey === "forgot-2" && (
            <>
              <h2 className="mb-2 text-center text-white font-['Nasaliza',sans-serif] text-[24px] tracking-wide">Reset Password</h2>
              <p className="mb-8 text-center text-sm text-white/60">
